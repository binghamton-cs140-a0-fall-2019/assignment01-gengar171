...
// or
	...
	public String toString() {
		String fmtSSN = getSSN();
		String fmtAddress = address.toString();
		return String.format(
			firstNames + " " + lastNames + " (" + fmtSSN + 
			"),\nDate and place of birth: " + placeDob.getDateOfBirth() + ", " + placeDob.getPlaceOfBirth()
			+ "\n" + fmtAddress
			);
	}
